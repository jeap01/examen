<%-- 
    Document   : index
    Created on : 18/09/2020, 09:30:45 PM
    Author     : Jose Amaya
--%>
...
<html>
    ...
    <body style="border-bottom-color: cornflowerblue" >
        <div>
        <h1 align="center" style="color:red" >Formulario Productos</h1>
        </div>
        <div class="container" style="color: gold"  >
            <form action="sr_productos" method="post" class="form-group">
                ...
                <input type="text" name="txt_producto" id="txt_producto" class="form-control" placeholder="Pepsi" required>
                ...
                <input type="text" name="txt_descripcion" size="30" id="txt_descripcion" class="form-control" placeholder="Buen Sabor " required>
                <label><b>Precio costo</b></label>
                <input type="number" step="any" name="txt_costop" id="txt_costop" class="form-control" placeholder="Example: Q150.50" required>
                <label><b>Precio Venta</b></label>
                <input type="number" step="any" name="txt_costov" id="txt_costov" class="form-control" placeholder="Example: Q 7.6" required>
